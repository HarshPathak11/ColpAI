  ...
  return (
    <footer className="w-full bg-gray-800 text-white py-10">
      <div className="container mx-auto px-4">
        {/* Social Icons */}
        <div className="w-full flex flex-wrap justify-center space-x-6 mb-6">
          {[FaFacebookF, FaTwitter, FaGooglePlusG, FaYoutube, FaInstagram, FaLinkedinIn, FaVk].map((Icon, index) => (
            <a
              key={index}
              href="#"
              className="text-gray-400 hover:text-white text-2xl border-2 border-gray-500 p-2 rounded-full transition m-2"
            >
              <Icon />
            </a>
          ))}
