...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-800 text-white py-10 px-2 md:px-16">
      <div className="container mx-auto px-4">
        ...
        <div className="w-full flex flex-wrap justify-center space-x-2 md:space-x-6 mb-6">
          {[FaFacebookF, FaTwitter,, FaYoutube, FaInstagram, FaLinkedinIn].map((Icon, index) => (
            <a
              key={index}
              href="#"
              className="text-gray-400 hover:text-white text-lg md:text-2xl border-2 border-gray-500 p-2 rounded-full transition m-2"
            >
              <Icon />
            </a>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm text-gray-300 justify-center md:justify-start">
          ...
          <div className="text-left">
            ...
            <ul>
              <li><a href="#" className="hover:text-white">All Analysis Solutions </a></li>
